...
CARDS = [
    ("탐색", "채록지 지도를 통해 전국의 설화·민요·무가 자료를 시각적으로 탐색합니다.", "지도로 탐색하기", "btn_explore", "pages/01_지도시각화.py"),
    ("이해", "모티프·이본을 비교 분석하고 AI와 함께 설화를 깊이 이해합니다.", "모티프 탐색하기", "btn_understand", "pages/02_모티프탐색_&_이본_대조.py"),
    ("활용", "설화를 현대어·아동용·영문·대본 등 다양한 형식으로 재가공합니다.", "현대역 생성하기", "btn_use", "pages/03_현대역_및_콘텐츠_생성.py"),
    ("기여", "내가 알고 있는 설화를 직접 기록해 플랫폼에 기여할 수 있습니다.", "설화 입력하기", "btn_contribute", "pages/04_설화입력.py"),
]
